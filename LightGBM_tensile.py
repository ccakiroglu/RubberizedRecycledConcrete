...
ax.scatter(yhat_train,y_train, marker='o',facecolor='steelblue',edgecolor='steelblue', label=r'$LightGBM\text{ }train$')
ax.scatter(yhat_test,y_test, marker='s',facecolor='darkviolet',edgecolor='darkviolet', label=r'$LightGBM\text{ }test$')
