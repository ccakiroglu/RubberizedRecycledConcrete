...
colnamesF=[r'$w/c$', r'$FM_{NCA}$', r'$NCA \text{ }[kg/m^3]$', \
...
Tdir='G:\\My Drive\\Papers\\2023\\RubberizedConcrete\\EXCELCSV\\Flexural2.csv'
df = read_csv(Tdir,header=0,names=colnamesF)
