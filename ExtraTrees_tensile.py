...
#space['subsample']=[0.5]
search = GridSearchCV(extraTreesModel, space, n_jobs=-1, cv=cv, refit=True)
...
ax.scatter(yhat_train,y_train, marker='o',facecolor='forestgreen',edgecolor='forestgreen', label=r'$ExtraTrees\text{ }train$')
ax.scatter(yhat_test,y_test, marker='s',facecolor='violet',edgecolor='violet', label=r'$ExtraTrees\text{ }test$')
