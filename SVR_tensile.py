...
ax.scatter(yhat_train,y_train, marker='o',facecolor='seagreen',edgecolor='seagreen', label=r'$SVR\text{ }train$')
ax.scatter(yhat_test,y_test, marker='s',facecolor='goldenrod',edgecolor='goldenrod', label=r'$SVR\text{ }test$')
xk=[0,8];yk=[0,8];ykPlus10Perc=[0,8.8];ykMinus10Perc=[0,7.2];
